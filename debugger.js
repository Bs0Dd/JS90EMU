...
function debugDisSet() {
    ...
    if (((DISADDR >= (RAM.length+RAMSTA)) && (DISADDR < ROTSTA))
        || ((ROMT == null) && (DISADDR >= ROTSTA) && (DISADDR < ROMSTA)) 
        || ((ROMT != null) && (DISADDR >= (ROMT.length+ROTSTA)) && (DISADDR < ROMSTA)) 
        || (DISADDR >= (ROM.length+ROMSTA))) {
        return;
    }
